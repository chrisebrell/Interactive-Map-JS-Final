...
const options = {
  method: 'GET',
  headers: {accept: 'application/json', Authorization: 'fsq3fymS/i3YrLU6I5Fqkw9PE5SzEO1IO7GY4EzPHU/Y1T0='}
};

fetch(`https://api.foursquare.com/v3/places/search?query=${business}&ll=${currentPosition[0]}%2C${currentPosition[1]}&limit=5`, options)
...
function displayData (response){
  ...
  for(let i = 0; i < response.results.length; i++) {
    ...
    L.marker([b.geocodes.main.latitude,b.geocodes.main.longitude]).addTo(map)
